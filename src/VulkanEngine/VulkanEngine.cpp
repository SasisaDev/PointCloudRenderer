...
VulkanEngine::VulkanEngine(GLFWwindow* window)
{
    ...
    Pipeline = new VulkanPipeline(&device);
}
...
void VulkanEngine::PickStartupPhysicalDevice()
{
    ...
    Logger::Log("Selected device: " + LTEXT(deviceProperties.deviceName));
}
...
void VulkanEngine::CreateLogicalDevice()
{
    ...
    if (_DEBUG)
    {
        Logger::Log("Required device extensions:");
    ...
    if (result != VK_SUCCESS) {
        Logger::Log("Failed creating VkDevice");
        throw std::runtime_error("failed to create logical device!");
        return;
    }

    Logger::Log("Created VkDevice");

    vkGetDeviceQueue(device, indices.graphicsFamily.value(), 0, &graphicsQueue);
    Logger::Log("Found VkQueue: Graphics");
    vkGetDeviceQueue(device, indices.presentFamily.value(), 0, &presentQueue);
    Logger::Log("Found VkQueue: Present");
}
...
void VulkanEngine::CreateSwapchain()
{
    ...
    Logger::Log("Created VkSwapchain");
...
void VulkanEngine::CreateRenderPass()
{
    ...
    Logger::Log("Created VkRenderPass");
}
...
void VulkanEngine::CreateFramebuffers()
{
    ...
    for (size_t i = 0; i < swapChainImageViews.size(); i++) {
        ...
        Logger::Log("Created swapchain VkFramebuffer");
    }
}
...
void VulkanEngine::CreateCommandPool()
{
    ...
    Logger::Log("Created VkCommandPool");
}
...
void VulkanEngine::CreateCommandBuffer()
{
    ...
    Logger::Log("Created VkCommandBuffer");
}
...
void VulkanEngine::RecordCmdBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
...
{
    uint32_t imageIndex;
    vkAcquireNextImageKHR(device, swapChain, UINT64_MAX, 0, VK_NULL_HANDLE, &imageIndex);

    vkResetCommandBuffer(commandBuffer, /*VkCommandBufferResetFlagBits*/ 0);
    RecordCmdBuffer(commandBuffer, imageIndex);
